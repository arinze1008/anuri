...
from .models import Profile, Callgroup
...
class UserExForm(forms.Form):
    name = forms.CharField(label=pgettext_lazy('Form field', 'Name'),
                                max_length=75, widget=forms.TextInput(attrs={'readonly': 'readonly'}))
