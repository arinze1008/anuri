# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-12-01 17:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('callgroup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='callgroup', to='userprofile.Callgroup')),
                ('extension', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='extend', to='extension.SipExtension', unique=True)),
